...
def main():
    ...
    # Get test confusion matrix    
    cm = confusion_matrix(y_test, y_hat_test)        
    plot_confusion_matrix(cm, target_values, False, "Confusion Matrix - K-NN sklearn")      
    plot_confusion_matrix(cm, target_values, True, "Confusion Matrix - K-NN sklearn normalized" )  
    plt.show()
